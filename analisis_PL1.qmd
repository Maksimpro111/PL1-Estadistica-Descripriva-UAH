---
title: "PL1 – PIB y Mercado laboral UE (1998–2019)"
author: "Alumno"
format:
  html:
    toc: true
...
## 2. Caso A: Estadísticos descriptivos PIB
...
## 4. Caso B: Actividad (LFSI_EMP_A_H – ACT en % población)
...
### 4.1 Estadísticos y tablas – Actividad
...
- Caso A: Comparando Occidente vs Este, y Pre/Post adhesión, se resumen diferencias de nivel y dispersión de PIB per cápita y sus crecimientos.
- Caso B: Se contrasta la tasa de actividad (participación) en los mismos grupos y fases.
- Conjunto: Se cuantifica la relación entre PIB per cápita y actividad laboral a nivel global y por subgrupos.
